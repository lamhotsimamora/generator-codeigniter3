		...
		<div class="card">
			<div class="card-body">
				...
				<div class="mb-3">
					...
					<input type="text" v-model="directory_project" ref="directory_project" class="form-control" id="exampleFormControlInput1" placeholder="C:\xampp\htdocs\myproject">
				</div>
				...
				<div class="mb-3">
					...
					<input type="text" @keyup="autoModelName" v-model="controller_name" ref="controller_name" 
					class="form-control" id="exampleFormControlInput2" placeholder="Users">
				</div>
				...
				<div class="mb-3">
					...
					<input type="text" v-model="model_name" ref="model_name" class="form-control" id="exampleFormControlInput3" placeholder="UserModel">
				</div>
				...
				<ul class="list-group">
					...
					<li v-for="data in data_fields" v-html="renderField(data.COLUMN_NAME)" 
					:class="getClassField(data.COLUMN_NAME)">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>
			You can generate controller file and model file automatically where inside model file functions has been generate  <br>
		</p>
		<hr>
		<p>
